    ...
    */
    ...
    private function init()
    {
        ...
        $this->arrScoresGenero = array(
            array("value" => "HIM", "text" => "Himnos Nacionales"),
            array("value" => "CLA", "text" => "Clasica"),
            array("value" => "BAR", "text" => "Barroca"),
            array("value" => "CON", "text" => "Contemporanea"),
            array("value" => "MOD", "text" => "Moderna"),
        );
    ...
    private function procesarPost()
    {
        ...
        if (Validators::IsEmpty($this->viewData["scoredocurl"])) {
            $this->viewData["error_scoredocurl"][]
                = "La URL del documento es requerido";
            $hasErrors = true;
        }
